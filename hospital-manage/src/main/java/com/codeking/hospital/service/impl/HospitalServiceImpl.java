package com.codeking.hospital.service.impl;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.codeking.hospital.mapper.OrderInfoMapper;
import com.codeking.hospital.mapper.ScheduleMapper;
import com.codeking.hospital.model.OrderInfo;
import com.codeking.hospital.model.Patient;
import com.codeking.hospital.model.Schedule;
import com.codeking.hospital.service.HospitalService;
import com.codeking.hospital.util.ResultCodeEnum;
import com.codeking.hospital.util.YyghException;
import lombok.Data;
...
public class HospitalServiceImpl implements HospitalService {
    ...
    public Map<String, Object> submitOrder(Map<String, Object> paramMap) {
        ...
        // todo 这个是模拟数据的，很坑，数据是mongodb中获取的，但是这个地方需要用 mysql去查询。所以干脆写死做测试，写成1
